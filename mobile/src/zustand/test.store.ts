...
import { CompletedTest, Question, Test } from '../mobile-types/front-types';
...
//on workspace load details -> set tests
//on open test setting - load test and details depends on user permission
